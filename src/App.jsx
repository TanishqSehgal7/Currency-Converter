...
function App() {
  ...
  return (
    <>
      ...
      style={
        {backgroundImage: `url('${"https://images.unsplash.com/photo-1708724324835-67976c26ac29?q=80&w=2084&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}')`}
      }>
        ...
        <form onSubmit={(e) => {
          ...
          <p className='w-full text-center text-3xl p-5 text-black font-extrabold'>Currency Converter</p>
